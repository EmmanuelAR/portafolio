...
export default function Hero() {
  ...
  const secondary =
    "shrink-0 border border-black/30 px-4 py-2 text-sm text-black/70 hover:border-black hover:bg-black hover:text-white transition-colors";
  return (
    <section className="border-b border-black px-4 py-20 sm:px-8">
      ...
      <div className="mt-8 flex flex-nowrap items-center gap-3 overflow-x-auto pb-2">
